...
由於部署在 GitHub Pages 子目錄（`/external_projects/badminton_notes/`），使用 Hash 路由避免伺服器配置問題。
...
```text
首頁:
https://wjprogramer.github.io/external_projects/badminton_notes/#/

內容列表:
https://wjprogramer.github.io/external_projects/badminton_notes/#/content

內容詳情:
https://wjprogramer.github.io/external_projects/badminton_notes/#/content/high-clear

學習路徑:
https://wjprogramer.github.io/external_projects/badminton_notes/#/learning-path

收藏:
https://wjprogramer.github.io/external_projects/badminton_notes/#/favorites
```
...
內容資料本身已包含多語言版本（見 `content-format.md`），直接根據當前語言顯示對應版本。
...
```bash
git add .
git commit -m "Update badminton notes"
